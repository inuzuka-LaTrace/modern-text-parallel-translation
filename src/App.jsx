...
　　　　...hofmannsthalData,
  ...
  // 状態リセットのみ（popstate経由など、URL操作を伴わない場合に使用）
              ...
              {filteredTexts.map((text) => (
                ...
                >
                  ...
                  <button
                    ...
                    title="テキスト情報へ移動"
                    className={`absolute top-2 right-2 w-6 h-6 flex items-center justify-center rounded text-xs transition-all select-none ${
                      selectedText === text.id
                        ? darkMode
